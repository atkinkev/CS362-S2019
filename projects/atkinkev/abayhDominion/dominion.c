...
/*
Refactored Cards: Switch Cases refactored to Functions
Refactored cards are adventurer, smithy, village, council room, great hall.
*/
...
int smithyRF(int currentPlayer, struct gameState* state, int handPos){
  //+3 Cards
  int i; 
  for (i = 0; i < 3; i++)
  {
...
int council_roomRF(int currentPlayer, struct gameState *state, int handPos){
      //+4 Cards
      int i;
      for (i = 0; i < 4; i++)
      {
...
int great_hallRF(int currentPlayer, struct gameState *state, int handPos){
      //+1 Card
      drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  if(card==adventurer){
        ...
        return council_roomRF(currentPlayer, state, handPos);
  }
  else if(card==smithy){
        return smithyRF(currentPlayer, state, handPos);
  }
  else if(card==village){
        return villageRF(currentPlayer, state, handPos);
  }
  else if(card==great_hall){
        return great_hallRF(currentPlayer, state, handPos);
  }
  else
